%%%This version of the model considres temperature (Range from 18-50 degrees C)
[top]
components : dengue
...
%%Two state variables: s: state number and t: current temperature in the cell
StateVariables: s t
StateValues : 0 22

InitialCellsValue : Dengue2SerosTemp.val
InitialValue : 0
